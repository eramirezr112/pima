angular.module('ViewSolicitudRecursosAL', ['ngMaterial'])
    .controller('ViewSolicitudRecursosALController', ['$scope', '$filter', '$mdDialog', '$location', 'usuario', 'solicitudData', 'SolicitudService', function($scope, $filter, $mdDialog, $location, usuario, solicitudData, SolicitudService) {
       
        $scope.title = "Solicitudes de Recursos Legal";
                ...
                SolicitudService.approveSolicitud(codSolicitud).then(function (result) {
                    ...
                    if (response == 1) {
                        ...
                        $mdDialog.show(confirmResult).then(function() {
                            ...
                            $location.path('/solicitud-recursos-al');
